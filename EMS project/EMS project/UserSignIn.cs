...
namespace EMS_project
{
    public partial class UserSignIn : Form
    {
        ...
        {
            string SignInConnection = @"Data Source=(LocalDB)\v11.0;AttachDbFilename=E:\Sunan\c#\EMS\Project-101\EMS project\EMS project\EMSdb.mdfIntegrated Security=True;Connect Timeout=30";
